...
export function Table(_a) {
    var _b;
    var columns = _a.columns, data = _a.data, _c = _a.emptyMessage, emptyMessage = _c === void 0 ? 'No data available' : _c, _d = _a.size, size = _d === void 0 ? 'medium' : _d, _e = _a.striped, striped = _e === void 0 ? false : _e, _f = _a.stickyHeader, stickyHeader = _f === void 0 ? false : _f, initialRowsPerPage = _a.initialRowsPerPage, _g = _a.showPaginationOnSinglePage, showPaginationOnSinglePage = _g === void 0 ? false : _g;
    ...
    var _l = useState(initialRowsPerPage !== null && initialRowsPerPage !== void 0 ? initialRowsPerPage : data.length), rowsPerPage = _l[0], setRowsPerPage = _l[1];
    ...
    var visibleRows = useMemo(function () {
        var sortedData = stableSort(data, getComparator(order, orderBy));
    ...
    return (_jsxs(Paper, { sx: { width: '100%', overflow: 'hidden' }, children: [_jsx(TableContainer, { children: _jsxs(MuiTable, { stickyHeader: stickyHeader, size: size, children: [_jsx(EnhancedTableHead, { order: order, orderBy: orderBy, onRequestSort: handleRequestSort, columns: columns }), _jsx(TableBody, { children: visibleRows.length > 0 ? (visibleRows.map(function (row, index) {
                            ...
                            })) : (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: columns.length, align: "center", children: emptyMessage }) })) })] }) }), initialRowsPerPage && (data.length > rowsPerPage || showPaginationOnSinglePage) && (_jsx(TablePagination, { rowsPerPageOptions: [5, 10, 25], component: "div", count: data.length, rowsPerPage: rowsPerPage, page: page, onPageChange: handleChangePage, onRowsPerPageChange: handleChangeRowsPerPage }))] }));
}
